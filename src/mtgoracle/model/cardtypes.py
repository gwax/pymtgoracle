...
card_type_association = Table('mtgoracle_card_types', DeclarativeBase.metadata,
      Column('cardname', Unicode(127), ForeignKey('mtgoracle_cards.name')),
      Column('type', Unicode(15), ForeignKey('mtgoracle_types.name')))

card_subtype_association = Table('mtgoracle_card_subtypes', DeclarativeBase.metadata,
      Column('cardname', Unicode(127), ForeignKey('mtgoracle_cards.name')),
